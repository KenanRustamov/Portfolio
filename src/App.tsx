      ...
      <main>
        <React.Fragment>
          ...
          <div className="sideLinks">
            ...
            <a href="https://www.linkedin.com/in/kenanrustamov/detail/overlay-view/urn:li:fsd_profileTreasuryMedia:(ACoAACYeiHUBD78BYiN6gdtSTxsf5OKLxrfh_DQ,1599339181248)/" target="_blank" rel="noopener noreferrer"><svg className="dynamicLogo" height="25" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 102.55 122.88"><path d="M102.55 122.88H0V0h77.66l24.89 26.44v96.44zm-6.42-6.9V30.44H73.44V5.91H6.51v110.07h89.62z" fill-rule="evenodd" clip-rule="evenodd"/></svg></a>
            <div>
