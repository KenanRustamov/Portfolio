...
const DataBlocks = (props: any) => {
    let content = 
    <div className={"data"}>
        <DataBlock id ={"1"} propInput ={{title: "Profile",infoTitle:"Kenan Rustamov", infoSubtitle:"Full Stack Developer", infoText:"I currently study Computer Science and am on the Pre-med track at the University of Pittsburgh. I am currently the fundraising chair for Oakland Outreach, a volunteering club at Pitt, and am in the process of creating a web development club.", infoImg: kenanPhoto}}></DataBlock>
        <DataBlock id ={"2"} propInput ={{title: "Work Experience",infoTitle:"BNY Mellon", infoSubtitle:"Full-Stack Software Engineering Intern", infoText: "Worked on a project to allow internal users to communicate with Fircosoft to verify large transactions.  Specifically worked on creating CRUD operations for the project and project setup.", infoImg: bnymellon}}></DataBlock>
        <DataBlock propInput ={{title: "",infoTitle:"Bentley Systems", infoSubtitle:"Full-Stack Software Engineering Intern", infoText: "Created the ability for end users of the application to add and remove users from projects, persisted in the backend.", infoImg: BentleyPhoto, alt: "Yes, that is my favorite shirt"}}></DataBlock>
        <DataBlock id ={"3"} propInput ={{title: "Projects",infoTitle:"Partify", infoSubtitle:"React/TypeScript/Scss", infoText:"Partify is an app that allows you to create a custom tailored playlist for any occasion based on the user and their friends' music tastes.", infoImg: partifyGif}}></DataBlock>
        <DataBlock propInput ={{title: "",infoTitle:"SnackCheck", infoSubtitle:"JavaScript/React-Native/Expo", infoText:"SnackCheck allows users to find recipes based on dietary preferences such as veganism or allergies such as shellfish.", infoImg: SnackCheck}}></DataBlock>
