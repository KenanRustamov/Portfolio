...
const DataBlocks = (props: any) => {
    let content = 
    <div className={"data"}>
        <DataBlock id ={"1"} github={"https://github.com/KenanRustamov"} link ={"https://www.linkedin.com/in/kenanrustamov/"} propInput ={{title: "Profile",infoTitle:"Kenan Rustamov", infoSubtitle:"Full Stack Developer", infoText:"I currently major in Computer Science with a minor in Chemistry at the University of Pittsburgh. I am currently the fundraising chair for Oakland Outreach, a volunteering club at Pitt, and am in the process of creating a club for underrepresented minorities at pitt.", infoImg: kenanPhoto, alt: "Professionalish looking photo at the beach"}}></DataBlock>
