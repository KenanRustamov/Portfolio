...
// Define layout types
type LayoutType = 'intro' | 'standard';
...
interface DataBlockProps {
    ...
    layoutType?: LayoutType; // Add layoutType prop
}
...
const DataBlock = (props: DataBlockProps) => {
    ...
    const renderIntroLayout = () => (
        <>
         {/* Keep original title structure for intro or add specific styling */}
         {props.propInput.title &&
        ...
        <div className="dataBlock-icons">
            ...
            {props.resume && (
                <a href={props.resume} target="_blank" rel="noopener noreferrer" aria-label="Resume">
                     <svg className="dynamicLogo" height="25" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 102.55 122.88"><path d="M102.55 122.88H0V0h77.66l24.89 26.44v96.44zm-6.42-6.9V30.44H73.44V5.91H6.51v110.07h89.62z" fillRule="evenodd" clip-rule="evenodd"/></svg>
